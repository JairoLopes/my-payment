<template>
  <div class="bg-gray-100 font-sans text-gray-800 overflow-x-hidden min-h-screen">
    ...
    <div class="px-4 py-10">
      <!-- Alterna entre PaymentForm e PaymentSuccess -->
      <component
        :is="showSuccess ? componentsMap.PaymentSuccess : componentsMap.PaymentForm"
        @payment-success="handlePaymentSuccess"
        @new-payment="handleNewPayment"
      />
    </div>
...
// Estado para alternar entre formulário e sucesso
...
// Volta para o formulário e limpa campos
